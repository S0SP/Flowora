  ...
  return (
    <header className="sticky top-0 z-30 flex h-12 w-full items-center justify-between border-b border-border bg-white/90 dark:bg-zinc-950/90 backdrop-blur-md px-5 flex-shrink-0">
      ...
      <div className="flex items-center gap-2.5">
        ...
        <button
          onClick={toggleDark}
          className="relative flex items-center justify-between w-[48px] h-[26px] bg-gray-100/60 dark:bg-zinc-800/80 border border-border/80 rounded-full p-1 cursor-pointer transition-all hover:bg-gray-100/80 focus:outline-none shrink-0"
