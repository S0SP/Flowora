...
import { Building2, Shield, Bell, MessageCircle, Mail, Phone, CreditCard, Receipt, Key, Lock, FileText, Upload, Plus, MoreHorizontal, RefreshCw, Loader2, Users, Copy, Trash2, UserPlus, Check, X, ChevronDown, SlidersHorizontal, Coins, Share2 } from "lucide-react"
                                  ...
                                  if (navigator.share) {
                                    try {
                                      await navigator.share({
                                        ...
                                        text: `Join my workspace on Flowora:`,
                                        url,
                                      });
                                    } catch (err) {
